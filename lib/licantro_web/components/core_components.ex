defmodule LicantroWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LicantroWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LicantroWeb.Gettext, "errors", msg, opts)
    end
  end
